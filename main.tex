...
\begin{proposition}
    ...
    elements in $V$ that should be unioned. Then $X$ can be partioned into a set
    $\emptyset \neq X' \subseteq X $ and $X \backslash X'$ such that if $F'$
    is the forest after performing all 
\end{proposition}
