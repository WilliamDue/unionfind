...
\begin{proof}
    Let $G = (V, E)$ be a graph where $(v, v) \notin E$, it will show that:
    \begin{gather*}
        \left| \left\{v : (v, u) \in E\right\} \right| < \left\lfloor \frac{|V|}{2} \right\rfloor \\
        \iff \\
        \left| \left\{u : (v, u) \in E\right\} \right| \geq \left\lfloor \frac{|V|}{2} \right\rfloor 
    \end{gather*}
\end{proof}
