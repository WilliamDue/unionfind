...
\end{align*}
The graph $(V, \bigcup_{B_i \in B} B_i)$ will have atleast one cycle. Since $E$
is an edge cover then $w_i$ must be component of some edge $e \in V$. Therefore,
there must be atleast one $(w_i, w_i) \in B_i$ since otherwise $w_i$ would not
be a component in an edge.
